...
public class ArrayListAlgorithms
    {
        ...
        public static void replaceWithCaps(ArrayList<String> wordList)
        {
            ...
            for (int i = 0; i < wordList.size(); i++)
            {
                ...
                if (currentWord.substring(currentWord.length() - 1, currentWord.length()).equals("s"))
                {
                    wordList.set(i, currentWord.toUpperCase());
                }
            }
        }
        ...
        {
            int minimumValue = intList.get(0);
            int minimumIndex = 0;
            for (int i = 0; i < intList.size(); i++)
            {
                if (intList.get(i) < minimumValue)
                {
                    minimumValue = intList.get(i);
                    minimumIndex = i;
                }
            }
            return minimumIndex;
        ...
        public static ArrayList<String> parseWordsAndReverse(String sentence)
        {
            ...
            while (newSentence.indexOf(" ") != -1)
            {
                ...
                splitList.add(0, newSentence.substring(0, index));
                newSentence = newSentence.substring(index + 1);
            }
            splitList.add(0, newSentence);
            return splitList;
        }
        ...
        public static ArrayList<Integer> modes(int[] numList)
        {
            ...
            for (int i = 0; i < numList.length; i++)
            {
                ...
                else if (counter == modeSize && modeSize != 1)
                {
                    modes.add(numList[i]);
                }
            }
